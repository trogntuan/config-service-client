...
import { Button, Table, Modal, Form, Input, Space, Popconfirm, message, Select, Card, Row, Col, Statistic } from 'antd';
import { PlusOutlined, EditOutlined, DeleteOutlined, ReloadOutlined, SearchOutlined, AppstoreOutlined, SettingOutlined } from '@ant-design/icons';
...
const App = () => {
  ...
  const applications = [...new Set(configs.map(config => config.application))];
  ...
  const columns = [
    ...
    { 
      ...
      key: 'application',
      render: (app) => <span className="font-semibold text-blue-600">{app}</span>,
    ...
    { 
      ...
      render: (profile) => (
        <span className={`px-2 py-1 rounded text-xs ${
          profile === 'default' ? 'bg-gray-100 text-gray-700' : 'bg-blue-100 text-blue-700'
        }`}>
          {profile}
        </span>
      ),
    ...
    { 
      ...
      key: 'propertyKey',
      render: (key) => <span className="font-mono text-sm bg-gray-50 px-2 py-1 rounded">{key}</span>,
    ...
    { 
      ...
      key: 'propertyValue',
      render: (value) => <span className="font-mono text-sm bg-green-50 px-2 py-1 rounded">{value}</span>,
      filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters }) => (
        <div style={{ padding: 8 }}>
          <Input
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage application configurations and properties</p>
            </div>
